function PLAYER_ATTACK_MOBILE(){
	 #region Normal shooting
	 var attack = device_mouse_check_button(0, mb_left);
	...
	var smartbomb_attack = global.Mobile_smartbomb_attack;
		...
		if (can_shoot_smartbomb) && (smartbomb_attack){
			...
			if (smartbomb_do_once){
				...
				global.Mobile_smartbomb_attack = false;
			}
